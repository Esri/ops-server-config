...
#==============================================================================
#Name:          WriteHostedServiceDefinitions.py
#           
#Purpose:       Output JSON file of all hosted service definitions
#               (i.e. service Sync, Tracking, Export and edting properties)
#
#==============================================================================
import sys
import os
...
from AGSRestFunctions import getHostedServiceDefinition
...
def check_args():
    ...
    if len(sys.argv) < 7:
        ...
        print '\n' + scriptName + ' <Server_FullyQualifiedDomainName> <Server_Port> <User_Name> <Password> <Use_SSL: Yes|No> <Output_File> {Owners}'
        ...
        print '\n\t<Output_File> (required): Path and name of file to write service definitions.'
    ...
    return server, port, adminuser, password, use_ssl, output_file, owners
