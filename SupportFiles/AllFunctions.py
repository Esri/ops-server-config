...
def getServiceInfo(server, port, adminUser,  adminPass, folder, serviceNameAndType, token=None):
    ...
    serviceInfo = {}       
    URL = "http://{}:{}/arcgis/admin/services/{}?f=pjson&token={}".format(server, port, folderServerNameType, token)    
...
def getServiceItemInfo(server, port, adminUser,  adminPass, folder, serverNameAndType, token=None):
    ...
    serviceItemInfo = {}       
    URL = "http://{}:{}/arcgis/admin/services/{}/iteminfo?f=pjson&token={}".format(server, port, folderServerNameType, token)    
...
def getConfigStoreProperty(server, port, adminUser, adminPass, token=None, property="connectionString"):
    ...
    directories = {}       
    URL = "http://{}:{}/arcgis/admin/system/configstore?f=pjson&token={}".format(server, port, token)    
...
def getServerDirectories(server, port, adminUser, adminPass, token=None):
    ...
    serverDirectories = {}       
    URL = "http://{}:{}/arcgis/admin/system/directories?f=pjson&token={}".format(server, port, token)    
...
def getDataItemInfo(server, port, adminUser,  adminPass, dataItemPath, token=None):
    ...
    dataItemInfo = {}       
    URL = "http://{}:{}/arcgis/admin/data/items{}?f=pjson&token={}".format(server, port, dataItemPath, token)    
