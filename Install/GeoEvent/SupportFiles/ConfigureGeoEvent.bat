...
rem #==============================================================================
rem # Name:          ConfigureGeoEvent.bat
rem #
rem # Purpose:       Configure GeoEvent Processor Extension for ArcGIS Server 
rem #
rem # Prerequisites:
rem #                - ArcGIS Server must be installed/authorized and ArcGIS Server
rem #                  site must exist.
rem #                - Geoevent extension must be installed/authorized.
rem #                - Ops Server IIS installation must have SSL certificate.
rem #
rem #==============================================================================
