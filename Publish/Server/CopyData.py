...
#           to Ops Server
#
#History:   7/6/2012: Fixed CR 237,114 - Add ServerCache to copy data script
#           7/6/2012: Fixed CR 237,109 - Copy Data should use the paths set
#                                       in ConfigureServer script.
#==============================================================================
import arcpy
